        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 sm:gap-12 lg:gap-16 items-start mb-16 sm:mb-20">
          ...
          <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
            {COMPANY_CONFIG.principles.map((principle, index) => {
              ...
              return (
                <Reveal key={principle.title} delay={index * 0.1} y={16}>
                  <div className="p-5 sm:p-6 bg-white border border-[#42124F]/15 rounded-xs shadow-xs hover:border-[#42124F]/40 hover:shadow-md transition-all duration-300 group">
        ...
        <div className="pt-12 sm:pt-16 border-t border-[#42124F]/15">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3.5 sm:gap-4">
            {COMPANY_CONFIG.pipelineStages.map((stage, idx) => (
              <Reveal key={stage.stage} delay={idx * 0.08} y={16}>
                <div className="p-4 sm:p-5 bg-white border border-[#42124F]/15 rounded-xs hover:border-[#42124F] transition-all duration-300 shadow-xs relative group">
